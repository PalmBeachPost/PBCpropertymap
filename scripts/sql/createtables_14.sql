...
BEGIN;
	/*----------------------------RAW Rec10 table--------------------------*/
		DROP TABLE IF EXISTS raw_rec10_14 CASCADE;
		CREATE TABLE IF NOT EXISTS raw_rec10_14(
			pcn varchar,
			recordCode varchar,
			propertyUse varchar,
			name varchar,
	...
	/*----------------------------RAW Rec20 table--------------------------*/
		DROP TABLE IF EXISTS raw_rec20_14 CASCADE;
		CREATE TABLE raw_rec20_14(
			pcn varchar,
			recordCode varchar,
			legalLine1 varchar,
			legalLine2 varchar,
	...
	/*----------------------------RAW Rec35 table--------------------------*/
		DROP TABLE IF EXISTS raw_rec35_14 CASCADE;
		CREATE TABLE raw_rec35_14(
			pcn varchar,
			recordCode varchar,
	...
	/*----------------------------RAW Rec36 table--------------------------*/
		DROP TABLE IF EXISTS raw_rec36_14 CASCADE;
		CREATE TABLE raw_rec36_14(
			pcn varchar,
			recordCode varchar,
			assessment1_type varchar,
			assessment1_authority varchar,
	...
	/*----------------------------RAW Rec40 table--------------------------*/
		DROP TABLE IF EXISTS raw_rec40_14 CASCADE;
		CREATE TABLE raw_rec40_14(
			pcn varchar,
			recordCode varchar,
			taxDistCode varchar,
			propUseCode varchar,
	...
	/*-----------------------------Property table-------------------------*/
	DROP TABLE IF EXISTS property_14 CASCADE;
	CREATE TABLE IF NOT EXISTS property_14(
	...
	CREATE INDEX ON property_14(marketVal);

	/*-----------------------------Assessments table-------------------------*/
	DROP TABLE IF EXISTS assessments_14 CASCADE;
	CREATE TABLE IF NOT EXISTS assessments_14(
		pcn varchar REFERENCES property_14(pcn),
		type varchar,
		auth varchar,
		amount numeric
	);
	CREATE INDEX ON assessments_14(pcn);
	CREATE INDEX ON assessments_14(auth);
	
	/*-----------------------------Tax table-------------------------*/
	DROP TABLE IF EXISTS tax_14 CASCADE;
	CREATE TABLE IF NOT EXISTS tax_14(
		pcn varchar REFERENCES property_14(pcn),
		tax numeric
	);
	CREATE INDEX ON tax_14(pcn);
COMMIT;