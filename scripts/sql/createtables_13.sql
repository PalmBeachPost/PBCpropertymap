...
BEGIN;
	...
	/*-----------------------------Property table-------------------------*/
	DROP TABLE IF EXISTS property_13 CASCADE;
	CREATE TABLE IF NOT EXISTS property_13(
	...
	CREATE INDEX ON property_13(marketVal);

	/*-----------------------------Assessments table-------------------------*/
	DROP TABLE IF EXISTS assessments_13 CASCADE;
	CREATE TABLE IF NOT EXISTS assessments_13(
